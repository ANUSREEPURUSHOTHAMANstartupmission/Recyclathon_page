...
<div id="navbar" class="w-64 min-h-screen sm:w-full sm:min-h-0 sm:h-20 p-8 sm:py-3 text-white bg-[#567763]  left-0 top-0 
    ...
    <div class="w-screen container mx-auto sm:flex sm:items-center sm:justify-between">
      <div class=" md:mx-10 m-0  font-medium w-fit p-0 rounded-md flex items-center justify-center">
        ...
        <img src="/Recyclathon_page/img/logo.svg" alt="logo" class=" {scrolled?'h-12':'h-16'}">
      </div>
      ...
      <nav>
        <ul class="sm:flex md:text-xs gap-2 w-full">
          ...
          <li on:click="{()=> menu_open = !menu_open }"  class="w-fit px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100" >
            ...
            <li on:click="{()=> menu_open = !menu_open }"  class="w-fit px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100">
              <a href="/#about" class=" md:text-[#567763] p-1 font-bold text-white hover:text-black font-data uppercase ">About</a>
            </li>
          
            <li on:click="{()=> menu_open = !menu_open }" class="w-fit px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100">
              <a href="/#problemstatements" class=" md:text-[#567763] p-1 font-bold text-white hover:text-black font-data uppercase">Problem Statements</a>
            </li>
            
            <li on:click="{()=> menu_open = !menu_open }" class="w-fit px-5 py-2 transform hover:bg-gray-400 transition duration-500 hover:scale-100">
              <a href="/#timeline" class=" md:text-[#567763] p-1 font-bold text-white hover:text-black font-data uppercase">Timeline</a>
            </li>
...
<main class="w-full fixed bg-white z-40" >
  <div class="flex sm:hidden" >        
    <img src="/Recyclathon_page/img/logo.svg" alt="Logo" class="p-1 object-contain h-12 px-2">
